    ...
    <section className="jais-port__hero" id='home'>
      <motion.div className="jais-port__hero-info" variants={container} initial={"hidden"} whileInView={"visible"} viewport={{ once: true }}>
        <motion.div className="line1" >
          ...
          <motion.h1 variants={item} style={{ margin:"0rem 0 1.5rem 0" }}>I am <span>
            Nilesh Jaiswar.
          </span></motion.h1>
          <motion.p variants={item} style={{ fontSize: "1.5rem" }}> A Full-Stack Developer with 2 years of experience specializing in the MERN Stack, Typecript Next JS and Nest JS Developer. Based in <span>Mumbai</span>.</motion.p>
          <motion.p variants={item} style={{ fontSize: "1.5rem" }}>Got Some Idea for your next <span>Project</span>?</motion.p>
        </motion.div>
